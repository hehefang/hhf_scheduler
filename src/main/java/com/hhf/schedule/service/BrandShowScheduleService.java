 ...
 * 
 */
package com.hhf.schedule.service;
...
import com.hhf.common.spring.SpringContextUtil;
import com.hhf.common.util.DateUtils;
import com.hhf.service.product.IBrandShowService;
import com.hhf.service.schedule.IBrandShowScheduleService;
...
public class BrandShowScheduleService implements IBrandShowScheduleService {
	 ...
	 * 
	 * @see
	 * com.hhf.service.schedule.IBrandShowScheduleService#registerBrandShowStartJob
	 * (int, java.util.Date)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.hhf.service.schedule.IBrandShowScheduleService#registerBrandShowEndJob
	 * (int, java.util.Date)
	 */
	@Override
